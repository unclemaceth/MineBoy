    ...
    <div style={{
      ...
      <div style={{
        ...
        display: 'flex',
          ...
          <p style={{ fontSize: 14, marginBottom: 8, opacity: 0.8 }}>
            Multi-device mining powered by ApeChain
          </p>
          ...
          {!isConnected ? (
            ...
            >
              ...
              <p style={{ fontSize: 12, marginTop: 16, opacity: 0.6 }}>
                You can insert up to {MAX_DEVICES} cartridges
              </p>
            </>
          )}
