...
interface FanSandwichProps {
  ...
  spinning: boolean;
  size?: number;
  /** Color variant to match shell: blue, orange, or green */
 ...
 */
export default function FanSandwich({ spinning, size = 100, color = 'blue' }: FanSandwichProps) {
  // Color mapping for grill gradients (hue-shifted to match shell)
  const colorMap = {
    blue: {
      grill1: ['rgb(109,136,197)', 'rgb(67,87,168)'],
      grill2: ['rgb(163,185,237)', 'rgb(116,134,187)', 'rgb(67,82,135)', 'rgb(44,57,111)'],
    },
    orange: {
      grill1: ['rgb(197,136,109)', 'rgb(168,87,67)'],
      grill2: ['rgb(237,185,163)', 'rgb(187,134,116)', 'rgb(135,82,67)', 'rgb(111,57,44)'],
    },
    green: {
      grill1: ['rgb(109,197,136)', 'rgb(67,168,87)'],
      grill2: ['rgb(163,237,185)', 'rgb(116,187,134)', 'rgb(67,135,82)', 'rgb(44,111,57)'],
    },
  };
  
  const colors = colorMap[color];
  const gradientIdSuffix = color;
